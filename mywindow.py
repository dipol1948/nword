...
#endif // QT_CONFIG(shortcut)
        self.root_7.setText(QCoreApplication.translate("MainWindow", u"Add", None))
#if QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
        self.rt.setText(QCoreApplication.translate("MainWindow", u"j", None))
#if QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
        self.root_2.setText(QCoreApplication.translate("MainWindow", u".", None))
#if QT_CONFIG(shortcut)
